...
SELECT models.name, brands.name, brands.headquarters FROM models
JOIN brands
...
SELECT * FROM brands WHERE brand_id = 'ram' OR brand_id = 'stu' OR brand_id = 'cad' ORDER BY founded;
...
ORDER BY b.name, m.name, m.year, b.discontinued, years_until_brand_discontinued;
